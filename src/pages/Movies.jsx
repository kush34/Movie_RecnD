  ...
  return (
    <div className='Movies'>
      ...
      <div className='flex justify-between px-24 pt-16 pb-12'>
        <div className='text-white text-6xl sm:text-8xl font-medium'>
      ...
      {/* displays list array */}
      <div className="list mt-2 pb-12 flex flex-col sm:flex-row flex-wrap sm:flex-nowrap md:flex-wrap justify-center items-center">
        {list.map((movie,index)=>{
          return(
              <button onClick={() => handleMovieClick(movie.id)} key={index} style={{
                ...
                }} className={`border-none text-white rounded-lg flex items-end border-2 m-4 w-3/4 xl:w-1/5  h-[50vh] bg-cover bg-center card hover:scale-105 ease-in duration-200 hover:shadow-md hover:shadow-sky-500/50`}>              
